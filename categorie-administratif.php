...
<body>
    ...
    <section class="intro">
        ...
        <div class="intro-container d-flex flex-column align-items-center">
            <h1 class="exclude-accessibility text">Administratif</h1>
            <div class="trait exclude-accessibility"></div>
            <p class="exclude-accessibility text">Voici une liste complète de ressources pour vous aider à gérer vos tâches administratives plus facilement, sans que cela ne vous stresse.</p>
        </div>
    </section>
    ...
    <div class="quiz">
        <h2>Quiz</h2>
        <div class="trait-bleu exclude-accessibility"></div>
        <div class="texte-img-quiz">
            <div class="texte-quiz">
                ...
                <button onclick="window.location.href='quiz.html?category=administratif&source=categorie-administratif.php'" class="btn fw-bold btn-quiz">Faire le quiz</button>
            </div>
            <div class="img-quiz">
