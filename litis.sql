...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 19 avr. 2024 à 13:56
...
(109, 'BIOS (Basic Input/Output System)', 'Programme intégré à la carte mère d\'un ordinateur, exécuté au démarrage de l\'appareil. Il initialise le matériel et charge le système d\'exploitation depuis le disque dur ou un autre support de stockage.', 'Firmware, micrologiciel, système de démarrage'),
...
(115, 'Blacklist', 'Liste noire; dans le contexte informatique, elle répertorie des entités (comme des adresses IP, des domaines, ou des adresses e-mail) qui sont bloquées ou interdites d\'accès pour des raisons de sécurité.', 'Liste noir, répertoire d’exclusion, index négatif'),
...
(130, 'Cloud', 'Un modèle de distribution de services informatiques via Internet, permettant l\'accès à des ressources telles que des serveurs, du stockage et des applications à la demande, souvent hébergées et gérées par des fournisseurs de services cloud.', 'Nuage informatique, service en ligne, stockage'),
...
(132, 'Coller', 'L\'action de copier du contenu depuis le presse-papiers de l\'ordinateur et de le placer dans un document ou une application, généralement effectuée après avoir copié le contenu à l\'aide de la fonction “Copier”.', 'Insérer, transférer'),
...
(136, 'Courriel', 'Message électronique envoyé et reçu via Internet.', 'Mail, e-mail, courrier électronique'),
(137, 'Courrier électronique', 'Un système de communication électronique permettant l\'échange de messages écrits entre des utilisateurs via des réseaux informatiques, tel que l\'Internet.', 'Email, E-mail, message électronique, message'),
(138, 'CPU (Unité Centrale de Traitement)', 'Le composant principal d\'un ordinateur responsable de l\'exécution des instructions et du traitement des données, souvent appelé \"processeur\".', 'Processeur, unité de traitement, microprocesseur'),
...
(156, 'Email', 'Un synonyme de \"courrier électronique\", désignant un message électronique envoyé et reçu via Internet.', 'Courriel, message, message électronique'),
...
(159, 'ENT (Environnement Numérique de Travail)', 'Une plateforme en ligne utilisée dans les établissements d\'enseignement pour fournir des outils et des services numériques aux étudiants, aux enseignants et au personnel administratif, facilitant l\'organisation, la communication et l\'apprentissage.', 'plateforme, éducation, espace, espace numérique'),
...
(163, 'Extension', 'Une suite de caractères ajoutée à la fin du nom de fichier d\'un fichier informatique pour indiquer son format ou son type de contenu, permettant aux systèmes d\'exploitation et aux applications de reconnaître et de traiter les fichiers correctement.', 'add-on, complément, module'),
...
(210, 'IP (Internet Protocol)', 'Numéro unique attribué à chaque appareil connecté à un réseau informatique utilisant le protocole Internet Protocol (IP), permettant l\'identification et la communication entre les appareils sur Internet.', 'Adresse IP, protocole IP'),
...
(240, 'Nom d\'utilisateur', 'Identifiant unique utilisé par un utilisateur pour accéder à un système informatique, un site web ou une application.', 'Identifiant, Username'),
...
(256, 'Pare-feu', 'Dispositif de sécurité réseau conçu pour surveiller et contrôler le trafic entrant et sortant, basé sur un ensemble de règles prédéfinies, afin de protéger un réseau ou un système informatique contre les attaques et les intrusions.', 'Pare-feu, coupe-feu, Firewall'),
...
(259, 'Partage de connexion', 'Le \"partage de connexion\" est une fonctionnalité qui permet à un appareil, comme un smartphone, de partager sa connexion Internet avec d\'autres appareils, tels que des ordinateurs portables ou des tablettes, via des connexions sans fil comme le Wi-Fi ou le Bluetooth.', 'Hotspot mobile, Tethering (Anglais), Point d’accès mobile, Partage de réseau, Partage de données mob'),
...
(276, 'Ram', 'Mémoire vive, composant informatique utilisé pour stocker temporairement des données et des programmes en cours d\'exécution sur un ordinateur, offrant un accès rapide aux informations nécessaires au processeur.', 'Mémoire vive, mémoire RAM, Random Access Memory'),
...
(278, 'Réglages', 'Options configurables et ajustables d\'un logiciel, d\'une application ou d\'un périphérique, permettant à l\'utilisateur de personnaliser et de contrôler son fonctionnement et son comportement.', 'Paramètres, options, Settings'),
...
(281, 'Répertoire', 'Structure de stockage utilisée pour organiser et classifier des fichiers, des documents ou des données sur un système de fichiers, permettant une navigation et un accès faciles.', 'Dossier, répertoire de fichiers, Directory'),
...
(314, 'USB', 'Un standard de connexion permettant de connecter des périphériques externes à un ordinateur, offrant une alimentation électrique et des capacités de transfert de données.', 'Port USB, connecteur USB, Universal Serial Bus'),
...
(325, 'Version', 'Une itération ou une édition spécifique d\'un logiciel, d\'une application ou d\'un système informatique, généralement identifiée par un numéro de version ou un nom de code, et qui peut inclure des mises à jour, des corrections de bugs, des améliorations, etc.', 'Édition, itération'),
...
(329, 'WWW', 'Le World Wide Web est un système d\'information hypertexte distribué permettant d\'accéder à des documents liés sur Internet. Il est souvent abrégé en WWW et constitue l\'un des services les plus utilisés sur Internet.', 'Web, Toile, Internet, World Wide Web'),
...
(335, 'Pointeur', 'Curseur ou marqueur sur un écran d\'ordinateur utilisé pour indiquer la position de l\'utilisateur et pour sélectionner des éléments ou des actions sur l\'interface utilisateur.', 'Curseur, flèche, Pointer'),
(336, 'Portable', 'Qualifie un logiciel ou un périphérique conçu pour être facilement transporté et utilisé en déplacement, souvent avec une alimentation autonome, une taille compacte et une connectivité sans fil.', 'Mobile, Laptop, Notebook'),
...
--
ALTER TABLE `glossaire`
  MODIFY `Id_glossaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=347;
