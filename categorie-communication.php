...
<head>
    ...
    <!--  -->
    <title>Ressources pour la Communication | Communication | Existence Numérique</title>
</head>
<body>
    ...
    <section class="intro">
        ...
        <div class="intro-container d-flex flex-column align-items-center">
            <h1 class="exclude-accessibility text">Communication</h1>
            <div class="trait exclude-accessibility"></div>
            <p class="exclude-accessibility text">Voici des ressources pour vous aider à utiliser les réseaux sociaux ou votre boite mail en toute facilité.</p>
        </div>
    </section>
    ...
    <section class="tutoriels">
        ...
        if ($result->rowCount() > 0) {
            ...
            echo "<div class='trait-rose exclude-accessibility'></div>";
...
<?php 
    ...
    <div class="quiz">
        <h2>Quiz</h2>
        <div class="trait-rose exclude-accessibility"></div>
        <div class="texte-img-quiz">
            <div class="texte-quiz">
                ...
                <button onclick="window.location.href='quiz.html?category=communication&source=categorie-communication.php'" class="btn fw-bold btn-quiz">Faire le quiz</button>
            </div>
            <div class="img-quiz">
